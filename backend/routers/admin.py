...
async def get_system_logs(
    ...
    Returns all non-mem logs raw (repair_queue, leaderboard_slow_response, events — low volume).
    ...
    # Fetch non-mem logs raw (low volume: repair_queue, leaderboard_slow_response, events)
