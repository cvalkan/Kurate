...
- **translational_potential**: How close is this work to real-world application? Consider industrial usage, clinical deployment, patentability, and other practical applicability. 1 = pure theory with no foreseeable application, 5 = clear potential for applied follow-up, 10 = directly applicable to industry, clinical use, or deployment. Use null if not meaningfully assessable.
