...
async def main():
    ...
    try:
        ...
        print(f"  v1 URL: https://atlas-optimized.preview.emergentagent.com/paper/{V1_ID}")
        print(f"  v2 URL: https://atlas-optimized.preview.emergentagent.com/paper/{V2_ID}")
        print(f"  v3 URL: https://atlas-optimized.preview.emergentagent.com/paper/{V3_ID} (latest)")
