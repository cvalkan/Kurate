...
/* =========================================================================
   How Kurate Rankings Work — shorter, 4 steps
   ========================================================================= */
const STEPS = [
    ...
    <section className="bg-white border-t border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-10 flex items-end justify-between gap-6">
          ...
          <a href="https://kurate.org/methodology" target="_blank" rel="noopener noreferrer" data-testid="full-methodology-link" className="hidden md:inline-flex items-center justify-center gap-2 rounded-sm border border-slate-200 bg-white px-4 h-10 text-sm font-medium text-slate-700 hover:bg-slate-50 whitespace-nowrap">
...
/* =========================================================================
   Why Category-Based Rankings Matter — unchanged but kept
   ========================================================================= */
...
export function WhoFor() {
  return (
    <section id="about" className="bg-slate-50 border-t border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-10 max-w-3xl">
