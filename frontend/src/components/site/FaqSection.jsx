...
const FAQS = [
  ...
  { q: "What are archive pages?", a: "Archive pages are weekly snapshots of category leaderboards, frozen every Monday. They let you see how papers were ranked during a particular week, even as live rankings continue to evolve. You can access them via the Live/Archive selector on any category leaderboard." },
  { q: "What are badges?", a: "Badges are awarded to the top 3 papers in each weekly archive snapshot. The paper ranked #1 receives a Gold badge, #2 Silver, and #3 Bronze. Badges are permanent and shareable. You can find them on each paper's detail page." },
];
