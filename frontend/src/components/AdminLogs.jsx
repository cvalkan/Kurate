            ...
            <table className="w-full text-xs" style={{ minWidth: "800px" }}>
              <thead>
                <tr className="bg-secondary/50 text-muted-foreground">
                  ...
                  <th className="px-3 py-2 text-left font-medium whitespace-nowrap">API</th>
                ...
                {filtered.map((log, i) => {
                  ...
                  return (
                    <tr key={i} className="border-t border-border/50 hover:bg-secondary/20">
                      ...
                      <td className="px-3 py-1.5 text-red-600 whitespace-nowrap" title={log.error}>{log.error}</td>
                    </tr>
                  );
                })}
                {!filtered.length && <tr><td colSpan={5} className="px-3 py-8 text-center text-muted-foreground">No errors found</td></tr>}
              </tbody>
            </table>
          </div>
        )}
