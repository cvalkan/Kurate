...
export default function PromptsPage() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 max-w-3xl py-6 md:py-10">
      ...
      <div className="mt-8 p-4 bg-secondary/30 rounded-lg border border-border text-xs text-muted-foreground space-y-2">
        ...
        <p><code className="font-mono text-foreground">{"{paper1_content}"}</code> contains both the paper's <strong>abstract</strong> and its <strong>AI impact summary</strong> (generated by Claude Opus 4.6 Thinking), formatted as:<br/>
        <code className="font-mono text-foreground block mt-1 ml-2">Abstract: ...<br/>AI Impact Assessment:<br/>...</code></p>
      </div>
    </div>
  );
}
