  ...
  const load = useCallback(async (append = false) => {
    ...
    try {
      ...
      const newPapers = (r.data.papers || []).map((p, i) => ({
        ...
        score: p.tournament_score || null,
        ts_score: p.tournament_score || null,
        ts_mu: p.tournament_ts_mu || null,
        ts_sigma: p.tournament_ts_sigma || null,
        win_rate: p.tournament_win_rate != null ? p.tournament_win_rate : null,
        comparisons: p.tournament_comparisons || null,
