  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-border" data-testid="hero-section">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl py-6 md:py-8 relative">
          <div className="max-w-3xl mb-4">
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-[2.75rem] font-semibold tracking-tight mb-2 text-foreground whitespace-nowrap" data-testid="hero-heading">
          ...
          <div className="mt-4" data-testid="hero-ranking-preview">
