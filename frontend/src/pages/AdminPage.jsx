      ...
      {activeTab === "settings" && settings && (
        ...
        <div className="space-y-6 max-w-xl" data-testid="admin-settings">
          ...
          <div className="border-t border-border pt-6 space-y-4">
            ...
            {[
              { key: "fetch_interval_hours", label: "Fetch Interval (hours)", dflt: 2, help: "How often to check arXiv for new papers. Safe range: 1-168. Default: 2.", min: 1, max: 168 },
              ...
              { key: "parallel_categories", label: "Parallel Categories", dflt: 10, help: "Categories processed concurrently per compare cycle. Higher = faster convergence but more memory. Safe range: 1-10. Default: 10.", min: 1, max: 10 },
              ...
              { key: "min_comparisons_converged", label: "Match Floor (stop matching after)", dflt: 50, help: "Papers with at least this many matches are considered converged even if confidence target isn't met. Prevents infinite matching of stubborn papers. They can still receive matches as opponents. Default: 50.", min: 10, max: 500 },
          ...
          if (data.length < 3) {
            ...
            return (
              <div className="h-full flex flex-col items-center justify-center">
                <span className="text-4xl font-bold" style={{ color }}>{latest[valueKey]}</span>
                <span className="text-[10px] text-muted-foreground mt-1">{fmtD(latest.date)}</span>
              </div>
            );
          }
          return (
