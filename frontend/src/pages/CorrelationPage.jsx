  ...
  return (
    <div className="container mx-auto px-4 md:px-6 max-w-5xl py-6 md:py-10">
      <Helmet>
        ...
        <meta name="description" content="How well do Claude Opus, GPT-5.2, and Gemini Pro agree on paper rankings? Spearman correlation analysis across AI judges." />
        ...
        <p className="text-muted-foreground text-sm max-w-2xl">
          How well do Claude Opus, GPT-5.2, and Gemini Pro agree on paper rankings?
        </p>
